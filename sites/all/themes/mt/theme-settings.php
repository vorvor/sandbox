 ...
 */
function mt_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['mt_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('mt sample setting'),
  '#default_value' => theme_get_setting('mt_example'),
